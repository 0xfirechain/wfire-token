...
/**
 * @dev Implementation of the {IToken} interface.
 *
 * This implementation is agnostic to the way tokens are created. This means
 * that a supply mechanism has to be added in a derived contract using {_mint}.
 * For a generic mechanism see {TokenPresetMinterPauser}.
 *
 ...
 * conventional and does not conflict with the expectations of token
 * applications.
 *
 ...
 * allowances. See {IToken-approve}.
 */
contract Token is Context, IToken, ITokenMetadata {
     ...
     * Ether and Wei. This is the value {Token} uses, unless this function is
     * overridden;
     *
     * NOTE: This information is only used for _display_ purposes: it in
     * no way affects any of the arithmetic of the contract, including
     * {IToken-balanceOf} and {IToken-transfer}.
     */
